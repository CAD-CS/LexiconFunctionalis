...
import Pretty (prettyPrintInvalidInput, prettyPrintSwitchDefListener, prettyPrintPrintDef, prettyPrintSwitchDef)
...
stateListener = do
    ...
    if (newState == "s") || (newState == "S") || (newState == "q") || (newState == "Q")
        then return newState
            ...
            putStrLn "Invalid input. Please select again"
            stateListener
